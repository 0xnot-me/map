...
$('#sw-version').text('2.25   (28-Feb-2023)');  // will be inserted in sidebar

// Make sure some checkboxes are checked/unchecked when loading
$('#layers-deeds').prop('checked', true);
$('#layers-highways').prop('checked', true);
$('#layers-bridges').prop('checked', true);
$('#layers-tunnels').prop('checked', true);
...
var map = (function () {
    ...
    var Map = function (params) {
        ...
        this.init = async function () {
            ...
            if (serverName === "Melody") {
                GRID_OFFSETX = 5;
                GRID_OFFSETY = -20;
            } else if (serverName === "Cadence") {
                MAP_WIDTH = 4096;
                MAP_HEIGHT = 4096;
                MIN_ZOOM = 0.25;
                MAX_ZOOM = 4;
                ...
                GRID_SPACING = 407.0;
                SCALE_FACTOR = 2.0;
            } else if (serverName === "Independence") {
                MAP_WIDTH = 4096;
                MAP_HEIGHT = 4096;
                MIN_ZOOM = 0.25;
                MAX_ZOOM = 4;
        ...
        this.drawHighways = function () {
            ...
            linesGroup.addWithUpdate();
            linesGroup.setCoords();
